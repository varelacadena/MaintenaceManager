...
ALTER TABLE uploads 
ADD COLUMN IF NOT EXISTS vehicle_check_out_log_id VARCHAR REFERENCES vehicle_check_out_logs(id) ON DELETE CASCADE,
ADD COLUMN IF NOT EXISTS vehicle_check_in_log_id VARCHAR REFERENCES vehicle_check_in_logs(id) ON DELETE CASCADE;
