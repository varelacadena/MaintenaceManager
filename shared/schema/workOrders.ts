...
export const tasks = pgTable("tasks", {
  ...
  vehicleName: varchar("vehicle_name", { length: 200 }),
  ...
  contactStaffId: varchar("contact_staff_id").references(() => users.id, { onDelete: "set null" }),
  contactStaffName: varchar("contact_staff_name", { length: 200 }),
